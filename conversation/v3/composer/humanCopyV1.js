...
const GLOBAL_OPENING_VARIANTS = Object.freeze([
  'Hola, soy el asesor IA de Luxetty. ¿Buscas comprar, vender o rentar una propiedad?',
...
function handoffAdvisorContinuation(firstName) {
  ...
  if (nm) {
    return `Perfecto, ${nm}. Un asesor de Luxetty continuará contigo por este medio. No necesitas hacer algo más por ahora.`;
  }
  return 'Perfecto. Un asesor de Luxetty continuará contigo por este medio. No necesitas hacer algo más por ahora.';
}
