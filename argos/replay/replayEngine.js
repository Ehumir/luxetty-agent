...
async function runReplayPack(pack, opts = {}) {
  ...
  try {
    ...
    if (previousEnv.argos === undefined) delete process.env.PERSEO_ARGOS_ENABLED;
    else process.env.PERSEO_ARGOS_ENABLED = previousEnv.argos;
    if (previousEnv.v3 === undefined) delete process.env.PERSEO_V3_ENABLED;
    else process.env.PERSEO_V3_ENABLED = previousEnv.v3;
  }
